...
public class ModifiedMainP3 {
	...
	public static void main(String args[])
	{
		...
		// run the naive algorithm
		{
			...
			System.out.println("Naive: For n = " + points.length + 
					 ", the average elapsed time is " +
					sumN/iterrN + " milliseconds.");
			System.out.println("");
			
			System.out.println("DC: For n = " + points.length + 
					 ", the average elapsed time is " +
					sumDC/iterrN + " milliseconds.");
			System.out.println("");
	}
	}
